...
#
# 用法：
#   bash <(curl -fsSL https://raw.githubusercontent.com/hiapb/ngsm/main/install.sh)
#
# 非交互全部用默认：
#   NONINTERACTIVE=1 bash <(curl -fsSL https://raw.githubusercontent.com/hiapb/ngsm/main/install.sh)
#
# 可选：
